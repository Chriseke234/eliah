...
import { CreditCard, Paperclip, Calendar, Flag } from 'lucide-react'
...
export function RequestCard({ request }: RequestCardProps) {
  ...
  return (
    <article
      className="group bg-slate-900 border border-slate-800/60 rounded-xl p-5 hover:border-slate-700/80 transition-all duration-200 hover:shadow-lg hover:shadow-slate-900/40"
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        ...
        {request.payment_link && (
          <a
            ...
            className="ml-auto flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-500/15 border border-emerald-500/30 text-emerald-300 text-xs font-medium hover:bg-emerald-500/25 transition-colors"
